...
contract PoolFactory {
    ...
    // report-written: missing error for pool does not exist
    ...
    constructor(address wethToken) {
        // report-written - lacks a zero-check
    ...
    function createPool(address tokenAddress) external returns (address) {
        ...
        // report-written - liquidityTokenSymbol is using .name() instead of .symbol()
