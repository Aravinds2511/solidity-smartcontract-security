...
//@audit-info: need to import IThunderLoan interface
    ...
    OracleUpgradeable
{
    ...
    // @audit-info: s_feeePrecision must to constant or immutable
    ...
    function deposit(
        ...
        //@audit-high : should not update the fee here.
    ...
    function getCalculatedFee(
        ...
        //@audit-high: if fee paid in the token, then it should be calculated in the token
